...
public class MemberAndAuth {
	...
	public MemberAndAuth(long m_no, String m_id, String m_name, String m_email, String m_phone, String m_password,
			long m_profile, long m_header, int m_delete, String m_rdate, int m_enabled, String a_auth) {
		this.m_no = m_no;
		this.username = m_id;
		this.m_name = m_name;
